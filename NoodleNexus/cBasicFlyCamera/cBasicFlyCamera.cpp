...
void cBasicFlyCamera::lookAt(const glm::vec3& targetPosition, glm::vec3 offset)
{
	// Calculate the adjusted target position with the XY offset
	glm::vec3 adjustedTargetPosition = targetPosition + glm::vec3(offset.x, offset.y, offset.z);
